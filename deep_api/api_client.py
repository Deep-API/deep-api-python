...
from deep_api.api_response import ApiResponse, T as ApiResponseT
import deep_api.models
from deep_api import rest
from deep_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'DeepAPI-python-1.0.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(deep_api.models, klass)
