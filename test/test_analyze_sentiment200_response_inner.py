...
class TestAnalyzeSentiment200ResponseInner(unittest.TestCase):
    """AnalyzeSentiment200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeSentiment200ResponseInner:
        """Test AnalyzeSentiment200ResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeSentiment200ResponseInner`
        """
        model = AnalyzeSentiment200ResponseInner()
        if include_optional:
            return AnalyzeSentiment200ResponseInner(
                sentiment = 'POSITIVE',
                score = 0.9
            )
        else:
    ...
    def testAnalyzeSentiment200ResponseInner(self):
        """Test AnalyzeSentiment200ResponseInner"""
